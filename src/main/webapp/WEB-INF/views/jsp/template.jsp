  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p class="lead">
El estudio y análisis de los factores que afectan a la innovación de productos de software para determinar el éxito de los mismos es crucial y determinante. 
Aplicando técnicas de evaluación de productos de software podemos determinar el éxito de los mismos.
</p>
