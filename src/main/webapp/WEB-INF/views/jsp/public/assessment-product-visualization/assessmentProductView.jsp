...
<div class="container">
		...
		<div class="row">
			<div class="col-sm-12" align="center">
				<p class="lead">Product innovation assessment questionnaire results</p>
			</div>
		</div>
	<div class="row">
	<div class="col-sm-12" align="center">
    	...
    	<c:forEach items="${dimensionList}" var="dimension" varStatus="status">
			<div id='pesta${status.index}' style='display:none;'>
                  <table style='width: 100%;'>
                         ...
                         <td valign='top'>
                             <button type='button' id="btn_submit" class="btn btn-primary" style="display: block;" onclick="showDiv2('editDiv')">Edit</button>
                         </td>
                     </tr>
           		</table>                        
           	</div>
    ...
    <table style="width:100%;">
       <tbody>
	    ...
	    <a href="<c:url value='/modern/assessment-product-chart'>
					<c:param name="evaluationId" value="${param.evaluationId}"/>
			    </c:url>" style="text-decoration:none;" target="_blank"><button type="button" id="btn_submit" class="btn btn-primary" style="display: block; margin-right: 2%;">Show Assessment Result</button></a>
                </td>
           </tr>
       </tbody>
    </table>
                    ...
                    <legend>Editing</legend>
				    	<c:forEach items="${dimensionList}" var="dimension" varStatus="status">
				    	 ...
				    	 <table style='width: 100%;'>
	                        <tr>
	                            <td>
	                                <button id="btn_submit" class="btn btn-primary" style = 'display: block; margin-left: 82%;' type="submit" value="Submit">Submit</button>
	                            </td>
	                            <td>
	                                <button id="btn_submit" class="btn btn-primary" style = 'display: block; margin-left: 2%;' onclick="showDiv2('editDiv');">Cancel</button>
	                            </td>
	                        </tr>
	                    </table>
                </fieldset>
